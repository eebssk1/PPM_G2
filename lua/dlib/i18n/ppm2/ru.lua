...
for _, _des_0 in ipairs({
  ...
  gui.ppm2.editor.eyes[tprefix].lightwarp.shader = tostring(prefix) .. "Использовать шейдер EyeRefract"
  gui.ppm2.editor.eyes[tprefix].lightwarp.cornera = tostring(prefix) .. "Испольщовать Cornera диффуз текстуру"
  gui.ppm2.editor.eyes[tprefix].lightwarp.glossiness = tostring(prefix) .. "Стеклянность (?)"
  gui.ppm2.editor.eyes[tprefix].type = tostring(prefix) .. "Тип глаза"
  gui.ppm2.editor.eyes[tprefix].reflection_type = tostring(prefix) .. "Тип отражений глаза"
  gui.ppm2.editor.eyes[tprefix].lines = tostring(prefix) .. "Линии радужной оболочки"
  gui.ppm2.editor.eyes[tprefix].derp = tostring(prefix) .. "Derp глаз"
  gui.ppm2.editor.eyes[tprefix].derp_strength = tostring(prefix) .. "Сила Derp глаза"
  gui.ppm2.editor.eyes[tprefix].iris_size = tostring(prefix) .. "Размер глаза"
  gui.ppm2.editor.eyes[tprefix].points_inside = tostring(prefix) .. "Линии радужной оболочки смотрят внутрь"
  gui.ppm2.editor.eyes[tprefix].width = tostring(prefix) .. "Ширина глаза"
  gui.ppm2.editor.eyes[tprefix].height = tostring(prefix) .. "Высота глаза"
  gui.ppm2.editor.eyes[tprefix].pupil.width = tostring(prefix) .. "Ширина зрачка"
  gui.ppm2.editor.eyes[tprefix].pupil.height = tostring(prefix) .. "Высота зрачка"
  gui.ppm2.editor.eyes[tprefix].pupil.size = tostring(prefix) .. "Размер зрачка"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_x = tostring(prefix) .. "Сдвиг зрачка по X"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_y = tostring(prefix) .. "Сдвиг зрачка по Y"
  gui.ppm2.editor.eyes[tprefix].pupil.rotation = tostring(prefix) .. "Поворот глаза"
  gui.ppm2.editor.eyes[tprefix].background = tostring(prefix) .. "Фон глаза"
  gui.ppm2.editor.eyes[tprefix].pupil_size = tostring(prefix) .. "Зрачок"
  gui.ppm2.editor.eyes[tprefix].top_iris = tostring(prefix) .. "Верхняя радужная оболочка"
  gui.ppm2.editor.eyes[tprefix].bottom_iris = tostring(prefix) .. "Нижняя радужная оболочка"
  gui.ppm2.editor.eyes[tprefix].line1 = tostring(prefix) .. "Радужная линия 1"
  gui.ppm2.editor.eyes[tprefix].line2 = tostring(prefix) .. "Радужная линия 2"
  gui.ppm2.editor.eyes[tprefix].reflection = tostring(prefix) .. "Эффект отражения"
  gui.ppm2.editor.eyes[tprefix].effect = tostring(prefix) .. "Эффект мультяшного глаза"
end
...
for i = 1, 2 do
  gui.ppm2.editor.mane['color' .. i] = "Цвет гривы " .. tostring(i)
  gui.ppm2.editor.mane.up['color' .. i] = "Цвет верхней гривы " .. tostring(i)
  gui.ppm2.editor.mane.down['color' .. i] = "Цвет нижней гривы " .. tostring(i)
end
for i = 1, 6 do
  gui.ppm2.editor.mane['detail_color' .. i] = "Деталь гривы " .. tostring(i)
  gui.ppm2.editor.mane.up['detail_color' .. i] = "Деталь верхней гривы " .. tostring(i)
  gui.ppm2.editor.mane.down['detail_color' .. i] = "Деталь нижней гривы " .. tostring(i)
  gui.ppm2.editor.url_mane['desc' .. i] = "URL деталь гривы " .. tostring(i)
  gui.ppm2.editor.url_mane['color' .. i] = "Цвет URL детали " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.up['desc' .. i] = "URL деталь верхней гривы " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.up['color' .. i] = "Цвет URL детали верхней гривы " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.down['desc' .. i] = "URL деталь нижней гривы " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.down['color' .. i] = "Цвет URL детали нижней гривы " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.horn.detail['desc' .. i] = "URL деталь рога " .. tostring(i)
  gui.ppm2.editor.horn.detail['color' .. i] = "Цвет URL детали рога " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.wings.details.def['detail' .. i] = "URL деталь крыльев " .. tostring(i)
  gui.ppm2.editor.wings.details.def['color' .. i] = "Цвет URL детали крыльев " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['detail' .. i] = "URL деталь бэт-крыльев " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['color' .. i] = "Цвет URL детали крыльев " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['detail' .. i] = "Bat wing деталь кожи бэт-крыльев " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['color' .. i] = "Цвет URL детали кожи бэт-крыльев " .. tostring(i)
end
...
for i = 1, PPM2.MAX_BODY_DETAILS do
  gui.ppm2.editor.body.detail['desc' .. i] = "Деталь " .. tostring(i)
  gui.ppm2.editor.body.detail['color' .. i] = "Цвет детали " .. tostring(i)
  gui.ppm2.editor.body.detail['glow' .. i] = "Деталь " .. tostring(i) .. " светится"
  gui.ppm2.editor.body.detail['glow_strength' .. i] = "Сила свечения " .. tostring(i) .. " детали"
  gui.ppm2.editor.body.detail.url['desc' .. i] = "Деталь " .. tostring(i)
  gui.ppm2.editor.body.detail.url['color' .. i] = "Цвет детали " .. tostring(i)
end
...
for i = 1, PPM2.MAX_TATTOOS do
  gui.ppm2.editor.tattoo['layer' .. i] = "Тату уровень " .. tostring(i)
end
...
for i = 1, 6 do
  gui.ppm2.editor.tail['detail' .. i] = "Цвет детали хвоста " .. tostring(i)
  gui.ppm2.editor.tail.url['detail' .. i] = "URL деталь хвоста " .. tostring(i)
  gui.ppm2.editor.tail.url['color' .. i] = "Цвет URL детали хвоста " .. tostring(i)
end
