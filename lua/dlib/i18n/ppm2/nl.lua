...
for _, _des_0 in ipairs({
  ...
  local tprefix, prefix
  tprefix, prefix = _des_0[1], _des_0[2]
  gui.ppm2.editor.eyes[tprefix].lightwarp.shader = tostring(prefix) .. "Gebruik EyeRefract shader"
  gui.ppm2.editor.eyes[tprefix].lightwarp.cornera = tostring(prefix) .. "Gebruik Eye Cornera diffuus"
  gui.ppm2.editor.eyes[tprefix].lightwarp.glossiness = tostring(prefix) .. "Glans"
  gui.ppm2.editor.eyes[tprefix].type = tostring(prefix) .. "Oogtype"
  gui.ppm2.editor.eyes[tprefix].reflection_type = tostring(prefix) .. "Type oogreflectie"
  gui.ppm2.editor.eyes[tprefix].lines = tostring(prefix) .. "Ooglijnen"
  gui.ppm2.editor.eyes[tprefix].derp = tostring(prefix) .. "Derp ogen"
  gui.ppm2.editor.eyes[tprefix].derp_strength = tostring(prefix) .. "Derp oog sterkte"
  gui.ppm2.editor.eyes[tprefix].iris_size = tostring(prefix) .. "Ooggrootte"
  gui.ppm2.editor.eyes[tprefix].points_inside = tostring(prefix) .. "Ooglijntjes binnenin"
  gui.ppm2.editor.eyes[tprefix].width = tostring(prefix) .. "Oogbreedte"
  gui.ppm2.editor.eyes[tprefix].height = tostring(prefix) .. "Ooghoogte"
  gui.ppm2.editor.eyes[tprefix].pupil.width = tostring(prefix) .. "Pupil breedte"
  gui.ppm2.editor.eyes[tprefix].pupil.height = tostring(prefix) .. "Pupil hoogte"
  gui.ppm2.editor.eyes[tprefix].pupil.size = tostring(prefix) .. "Pupil grootte"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_x = tostring(prefix) .. "Pupil verschuiving X"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_y = tostring(prefix) .. "Pupil verschuiving Y"
  gui.ppm2.editor.eyes[tprefix].pupil.rotation = tostring(prefix) .. "Oog rotatie"
  gui.ppm2.editor.eyes[tprefix].background = tostring(prefix) .. "Oog achtergrond"
  gui.ppm2.editor.eyes[tprefix].pupil_size = tostring(prefix) .. "Pupil"
  gui.ppm2.editor.eyes[tprefix].top_iris = tostring(prefix) .. "Bovenste oog iris"
  gui.ppm2.editor.eyes[tprefix].bottom_iris = tostring(prefix) .. "Onderste oog iris"
  gui.ppm2.editor.eyes[tprefix].line1 = tostring(prefix) .. "Oog lijn 1"
  gui.ppm2.editor.eyes[tprefix].line2 = tostring(prefix) .. "Oog lijn 2"
  gui.ppm2.editor.eyes[tprefix].reflection = tostring(prefix) .. "Oogreflectie effect"
  gui.ppm2.editor.eyes[tprefix].effect = tostring(prefix) .. "Oog effect"
end
...
for i = 1, 2 do
  gui.ppm2.editor.mane['color' .. i] = "Mane kleur " .. tostring(i)
  gui.ppm2.editor.mane.up['color' .. i] = "Bovenste mane kleur " .. tostring(i)
  gui.ppm2.editor.mane.down['color' .. i] = "Onderste mane kleur " .. tostring(i)
end
for i = 1, 6 do
  gui.ppm2.editor.mane['detail_color' .. i] = "Mane detail kleur " .. tostring(i)
  gui.ppm2.editor.mane.up['detail_color' .. i] = "Bovenste mane kleur " .. tostring(i)
  gui.ppm2.editor.mane.down['detail_color' .. i] = "Onderste mane kleur " .. tostring(i)
  gui.ppm2.editor.url_mane['desc' .. i] = "Mane URL Detail " .. tostring(i) .. " invoer veld"
  gui.ppm2.editor.url_mane['color' .. i] = "Mane URL detail kleur " .. tostring(i)
  gui.ppm2.editor.url_tail['desc' .. i] = "Staart URL Detail " .. tostring(i) .. " invoer veld"
  gui.ppm2.editor.url_tail['color' .. i] = "Staart URL detail kleur " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.up['desc' .. i] = "Bovenste mane URL Detail " .. tostring(i) .. " invoer veld"
  gui.ppm2.editor.url_mane.sep.up['color' .. i] = "Bovenste Mane URL detail kleur " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.down['desc' .. i] = "Onderste mane URL Detail " .. tostring(i) .. " invoer veld"
  gui.ppm2.editor.url_mane.sep.down['color' .. i] = "Onderste Mane URL detail kleur " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.horn.detail['desc' .. i] = "Hoorn URL detail " .. tostring(i)
  gui.ppm2.editor.horn.detail['color' .. i] = "URL Detail kleur " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.wings.details.def['detail' .. i] = "Vleugels URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.def['color' .. i] = "URL Detail kleur " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['detail' .. i] = "Vleermuisvleugels URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['color' .. i] = "Vleermuisvleugels URL Detail kleur " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['detail' .. i] = "Vleermuisvleugels huid URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['color' .. i] = "Vleermuisvleugels huid URL Detail kleur " .. tostring(i)
end
...
for i = 1, PPM2.MAX_BODY_DETAILS do
  gui.ppm2.editor.body.detail['desc' .. i] = "Detail " .. tostring(i)
  gui.ppm2.editor.body.detail['color' .. i] = "Detail kleur " .. tostring(i)
  gui.ppm2.editor.body.detail['glow' .. i] = "Detail " .. tostring(i) .. " gloeit"
  gui.ppm2.editor.body.detail['glow_strength' .. i] = "Detail " .. tostring(i) .. " gloeikracht"
  gui.ppm2.editor.body.detail.url['desc' .. i] = "Detail " .. tostring(i)
  gui.ppm2.editor.body.detail.url['color' .. i] = "Detail kleur " .. tostring(i)
end
...
for i = 1, PPM2.MAX_TATTOOS do
  gui.ppm2.editor.tattoo['layer' .. i] = "Tatoegeringslaag " .. tostring(i)
end
...
for i = 1, 6 do
  gui.ppm2.editor.tail['detail' .. i] = "Staart detail kleur " .. tostring(i)
  gui.ppm2.editor.tail.url['detail' .. i] = "Staart URL detail " .. tostring(i)
  gui.ppm2.editor.tail.url['color' .. i] = "Staart URL detail " .. tostring(i)
end
