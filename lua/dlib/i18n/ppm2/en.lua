...
for _, _des_0 in ipairs({
  ...
  gui.ppm2.editor.eyes[tprefix].lightwarp.shader = tostring(prefix) .. "Use EyeRefract shader"
  gui.ppm2.editor.eyes[tprefix].lightwarp.cornera = tostring(prefix) .. "Use Eye Cornera diffuse"
  gui.ppm2.editor.eyes[tprefix].lightwarp.glossiness = tostring(prefix) .. "Glossiness"
  gui.ppm2.editor.eyes[tprefix].type = tostring(prefix) .. "Eye type"
  gui.ppm2.editor.eyes[tprefix].reflection_type = tostring(prefix) .. "Eye reflection type"
  gui.ppm2.editor.eyes[tprefix].lines = tostring(prefix) .. "Eye lines"
  gui.ppm2.editor.eyes[tprefix].derp = tostring(prefix) .. "Derp eye"
  gui.ppm2.editor.eyes[tprefix].derp_strength = tostring(prefix) .. "Derp eye strength"
  gui.ppm2.editor.eyes[tprefix].iris_size = tostring(prefix) .. "Eye size"
  gui.ppm2.editor.eyes[tprefix].points_inside = tostring(prefix) .. "Eye lines points inside"
  gui.ppm2.editor.eyes[tprefix].width = tostring(prefix) .. "Eye width"
  gui.ppm2.editor.eyes[tprefix].height = tostring(prefix) .. "Eye height"
  gui.ppm2.editor.eyes[tprefix].pupil.width = tostring(prefix) .. "Pupil width"
  gui.ppm2.editor.eyes[tprefix].pupil.height = tostring(prefix) .. "Pupil height"
  gui.ppm2.editor.eyes[tprefix].pupil.size = tostring(prefix) .. "Pupil size"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_x = tostring(prefix) .. "Pupil Shift X"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_y = tostring(prefix) .. "Pupil Shift Y"
  gui.ppm2.editor.eyes[tprefix].pupil.rotation = tostring(prefix) .. "Eye rotation"
  gui.ppm2.editor.eyes[tprefix].background = tostring(prefix) .. "Eye background"
  gui.ppm2.editor.eyes[tprefix].pupil_size = tostring(prefix) .. "Pupil"
  gui.ppm2.editor.eyes[tprefix].top_iris = tostring(prefix) .. "Top eye iris"
  gui.ppm2.editor.eyes[tprefix].bottom_iris = tostring(prefix) .. "Bottom eye iris"
  gui.ppm2.editor.eyes[tprefix].line1 = tostring(prefix) .. "Eye line 1"
  gui.ppm2.editor.eyes[tprefix].line2 = tostring(prefix) .. "Eye line 2"
  gui.ppm2.editor.eyes[tprefix].reflection = tostring(prefix) .. "Eye reflection effect"
  gui.ppm2.editor.eyes[tprefix].effect = tostring(prefix) .. "Eye effect"
end
...
for i = 1, 2 do
  gui.ppm2.editor.mane['color' .. i] = "Mane color " .. tostring(i)
  gui.ppm2.editor.mane.up['color' .. i] = "Upper mane color " .. tostring(i)
  gui.ppm2.editor.mane.down['color' .. i] = "Lower mane color " .. tostring(i)
end
for i = 1, 6 do
  gui.ppm2.editor.mane['detail_color' .. i] = "Mane detail color " .. tostring(i)
  gui.ppm2.editor.mane.up['detail_color' .. i] = "Upper mane color " .. tostring(i)
  gui.ppm2.editor.mane.down['detail_color' .. i] = "Lower mane color " .. tostring(i)
  gui.ppm2.editor.url_mane['desc' .. i] = "Mane URL Detail " .. tostring(i) .. " input field"
  gui.ppm2.editor.url_mane['color' .. i] = "Mane URL detail color " .. tostring(i)
  gui.ppm2.editor.url_tail['desc' .. i] = "Tail URL Detail " .. tostring(i) .. " input field"
  gui.ppm2.editor.url_tail['color' .. i] = "Tail URL detail color " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.up['desc' .. i] = "Upper mane URL Detail " .. tostring(i) .. " input field"
  gui.ppm2.editor.url_mane.sep.up['color' .. i] = "Upper Mane URL detail color " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.down['desc' .. i] = "Lower mane URL Detail " .. tostring(i) .. " input field"
  gui.ppm2.editor.url_mane.sep.down['color' .. i] = "Lower Mane URL detail color " .. tostring(i)
end
...
for i = 1, 3 do
  ...
  gui.ppm2.editor.horn.detail['color' .. i] = "URL Detail color " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.wings.details.def['detail' .. i] = "Wings URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.def['color' .. i] = "URL Detail color " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['detail' .. i] = "Bat wing URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['color' .. i] = "Bat wing URL Detail color " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['detail' .. i] = "Bat wing skin URL detail " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['color' .. i] = "Bat wing skin URL Detail color " .. tostring(i)
end
...
for i = 1, PPM2.MAX_BODY_DETAILS do
  ...
  gui.ppm2.editor.body.detail['color' .. i] = "Detail color " .. tostring(i)
  gui.ppm2.editor.body.detail['glow' .. i] = "Detail " .. tostring(i) .. " is glowing"
  gui.ppm2.editor.body.detail['glow_strength' .. i] = "Detail " .. tostring(i) .. " glow strength"
  gui.ppm2.editor.body.detail.url['desc' .. i] = "Detail " .. tostring(i)
  gui.ppm2.editor.body.detail.url['color' .. i] = "Detail color " .. tostring(i)
end
...
for i = 1, PPM2.MAX_TATTOOS do
  gui.ppm2.editor.tattoo['layer' .. i] = "Tattoo layer " .. tostring(i)
end
...
for i = 1, 6 do
  gui.ppm2.editor.tail['detail' .. i] = "Tail detail color " .. tostring(i)
  gui.ppm2.editor.tail.url['detail' .. i] = "Tail URL detail " .. tostring(i)
  gui.ppm2.editor.tail.url['color' .. i] = "Tail URL detail " .. tostring(i)
end
