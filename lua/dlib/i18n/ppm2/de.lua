...
for _, _des_0 in ipairs({
  ...
  gui.ppm2.editor.eyes[tprefix].lightwarp.shader = tostring(prefix) .. "EyeRefract Shader verwenden"
  gui.ppm2.editor.eyes[tprefix].lightwarp.cornera = tostring(prefix) .. "Eye Cornea diffus verwenden"
  gui.ppm2.editor.eyes[tprefix].lightwarp.glossiness = tostring(prefix) .. "Glanz"
  gui.ppm2.editor.eyes[tprefix].type = tostring(prefix) .. "Augentyp"
  gui.ppm2.editor.eyes[tprefix].reflection_type = tostring(prefix) .. "Augenreflexion typ"
  gui.ppm2.editor.eyes[tprefix].lines = tostring(prefix) .. "Augenlinien"
  gui.ppm2.editor.eyes[tprefix].derp = tostring(prefix) .. "Derp Augen"
  gui.ppm2.editor.eyes[tprefix].derp_strength = tostring(prefix) .. "Derp Augen Stärke"
  gui.ppm2.editor.eyes[tprefix].iris_size = tostring(prefix) .. "Augengröße"
  gui.ppm2.editor.eyes[tprefix].points_inside = tostring(prefix) .. "Augenlinien innen"
  gui.ppm2.editor.eyes[tprefix].width = tostring(prefix) .. "Augenbreite"
  gui.ppm2.editor.eyes[tprefix].height = tostring(prefix) .. "Augenhöhe"
  gui.ppm2.editor.eyes[tprefix].pupil.width = tostring(prefix) .. "Pupillenbreite"
  gui.ppm2.editor.eyes[tprefix].pupil.height = tostring(prefix) .. "Pupillenhöhe"
  gui.ppm2.editor.eyes[tprefix].pupil.size = tostring(prefix) .. "Pupillengröße"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_x = tostring(prefix) .. "Pupillen Verschiebung X"
  gui.ppm2.editor.eyes[tprefix].pupil.shift_y = tostring(prefix) .. "Pupillen Verschiebung Y"
  gui.ppm2.editor.eyes[tprefix].pupil.rotation = tostring(prefix) .. "Augenrotation"
  gui.ppm2.editor.eyes[tprefix].background = tostring(prefix) .. "Augenhintergrund"
  gui.ppm2.editor.eyes[tprefix].pupil_size = tostring(prefix) .. "Pupille"
  gui.ppm2.editor.eyes[tprefix].top_iris = tostring(prefix) .. "Obere Augeniris"
  gui.ppm2.editor.eyes[tprefix].bottom_iris = tostring(prefix) .. "Untere Augeniris"
  gui.ppm2.editor.eyes[tprefix].line1 = tostring(prefix) .. "Augenlinie 1"
  gui.ppm2.editor.eyes[tprefix].line2 = tostring(prefix) .. "Augenlinie 2"
  gui.ppm2.editor.eyes[tprefix].reflection = tostring(prefix) .. "Augenreflexionseffekt"
  gui.ppm2.editor.eyes[tprefix].effect = tostring(prefix) .. "Augeneffekt"
end
...
for i = 1, 2 do
  gui.ppm2.editor.mane['color' .. i] = "Mähnefarbe " .. tostring(i)
  gui.ppm2.editor.mane.up['color' .. i] = "Obere Mähnefarbe " .. tostring(i)
  gui.ppm2.editor.mane.down['color' .. i] = "Untere Mähnefarbe " .. tostring(i)
end
for i = 1, 6 do
  gui.ppm2.editor.mane['detail_color' .. i] = "Mähne Detail Farbe " .. tostring(i)
  gui.ppm2.editor.mane.up['detail_color' .. i] = "Obere Mähnefarbe " .. tostring(i)
  gui.ppm2.editor.mane.down['detail_color' .. i] = "Untere Mähnefarbe " .. tostring(i)
  gui.ppm2.editor.url_mane['desc' .. i] = "Mähne URL Detail " .. tostring(i) .. " Eingabefeld"
  gui.ppm2.editor.url_mane['color' .. i] = "Mähne URL Detail Farbe " .. tostring(i)
  gui.ppm2.editor.url_tail['desc' .. i] = "Schweif URL Detail " .. tostring(i) .. " Eingabefeld"
  gui.ppm2.editor.url_tail['color' .. i] = "Schweif URL detail Farbe " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.up['desc' .. i] = "Obere Mähne URL Detail " .. tostring(i) .. " Eingabefeld"
  gui.ppm2.editor.url_mane.sep.up['color' .. i] = "Obere Mähne URL Detail Farbe " .. tostring(i)
  gui.ppm2.editor.url_mane.sep.down['desc' .. i] = "Untere Mähne URL Detail " .. tostring(i) .. " Eingabefeld"
  gui.ppm2.editor.url_mane.sep.down['color' .. i] = "Untere Mähne URL Detail Farbe " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.horn.detail['desc' .. i] = "Horn URL Detail " .. tostring(i)
  gui.ppm2.editor.horn.detail['color' .. i] = "URL Detail Farbe " .. tostring(i)
end
...
for i = 1, 3 do
  gui.ppm2.editor.wings.details.def['detail' .. i] = "Flügel URL Detail " .. tostring(i)
  gui.ppm2.editor.wings.details.def['color' .. i] = "URL Detail Farbe " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['detail' .. i] = "Bat Flügel URL Detail " .. tostring(i)
  gui.ppm2.editor.wings.details.bat['color' .. i] = "Bat Flügel URL Detail Farbe " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['detail' .. i] = "Bat Flügel Haut URL Detail " .. tostring(i)
  gui.ppm2.editor.wings.details.batskin['color' .. i] = "Bat Flügel Haut URL Detail Farbe " .. tostring(i)
end
...
for i = 1, PPM2.MAX_BODY_DETAILS do
  ...
  gui.ppm2.editor.body.detail['color' .. i] = "Detail Farbe " .. tostring(i)
  gui.ppm2.editor.body.detail['glow' .. i] = "Detail " .. tostring(i) .. " leuchtet"
  gui.ppm2.editor.body.detail['glow_strength' .. i] = "Detail " .. tostring(i) .. " leuchtkraft"
  gui.ppm2.editor.body.detail.url['desc' .. i] = "Detail " .. tostring(i)
  gui.ppm2.editor.body.detail.url['color' .. i] = "Detail Farbe " .. tostring(i)
end
...
for i = 1, PPM2.MAX_TATTOOS do
  gui.ppm2.editor.tattoo['layer' .. i] = "Tattooschicht " .. tostring(i)
end
...
for i = 1, 6 do
  gui.ppm2.editor.tail['detail' .. i] = "Schweif Detail Farbe " .. tostring(i)
  gui.ppm2.editor.tail.url['detail' .. i] = "Schweif URL Detail " .. tostring(i)
  gui.ppm2.editor.tail.url['color' .. i] = "Schweif URL Detail " .. tostring(i)
end
